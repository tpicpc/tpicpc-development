...
function ContractUs() {
  return (
    ...
    <div style={{background:"linear-gradient(89.98deg,hsla(0,0%,85%,0) .01%,#fbba31 34.37%,#fbba31.69%,hsla(0,0%,85%,0) 99.97%)"}}
        ...
        <p className="lg:w-2/3 mx-auto leading-relaxed text-base">We welcome any questions or feedback you may have.
            Please feel free to contact us using the information provided above or by filling out the form below.
        </p>
    ...
    <div className=" px-5 py-24 mx-auto flex md:flex-nowrap flex-wrap">
        <div
            ...
            <div className="backdrop-blur-md bg-white/30 relative flex flex-wrap py-6 rounded shadow-md">
                <div className="lg:w-1/2 px-6">
                    ...
                    <p className="mt-1 text-white">Gobindra Nogor, Thakurgaon Road , Thakurgaon</p>
                </div>
        ...
        <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
            ...
            <button
                className=" bg-primary py-3 px-6  rounded text-white text-xl font-medium hover:bg-secondary">Send</button>

            <p className="text-xs text-gray-500 mt-3">Thank you for visiting the TPI Computer & Programming Club
                website. We look forward to hearing from you!</p>
        </div>
    </div>
</section>
